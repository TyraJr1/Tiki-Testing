...
async function TC021() {
  ...
  try {
    ...
    const checkbox1 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[2]/div/div/div/div[1]/span'
      )
    );
    ...
    const checkbox3 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[4]/div/div[1]/div/div[1]/span'
      )
    );
    ...
    await driver.wait(until.elementIsVisible(scrollContainer), 5000);
    ...
    const checkbox4 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[6]/div/label[1]/div/div[1]/span'
      )
    );
    ...
    const checkbox5 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[7]/div/label[1]/div/div[1]/span'
      )
    );
    await driver.executeScript("arguments[0].click();", checkbox5);
    await driver.sleep(1000);

    // Fill the input with "-5"
    ...
    console.error("Lỗi trong TC021:", error);
  } finally {
