...
async function TC025() {
  ...
  try {
    ...
    const checkbox4 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[6]/div/label[5]/div/div[1]/span'
      )
    );
    ...
    console.error("Lỗi trong TC025:", error);
  } finally {
