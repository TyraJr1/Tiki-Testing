...
async function TC022() {
  ...
  try {
    ...
    const checkbox2 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[3]/div/div[2]/div/div/span'
      )
    );
    ...
    const checkbox3 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[4]/div/div[2]/div/div[1]/span'
      )
    );
    ...
    const checkbox5 = await driver.findElement(
      By.xpath(
        '//*[@id="__next"]/div[2]/main/div/div/div[2]/div[2]/div[4]/div[3]/div[2]/div[2]/div[7]/div/label[2]/div/div[1]/span'
      )
    );
    ...
    console.error("Lỗi trong TC022:", error);
  } finally {
